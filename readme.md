...
```
$ docker run --rm -it ghcr.io/oxidize-rb/xrubies__aarch64-linux__3.1:ubuntu \
  /opt/xrubies/3.1/bin/ruby -v
ruby 3.1.2p20 (2022-04-12 revision 4491bb740a) [aarch64-linux-gnu]
```

```sh
docker run --rm -it ghcr.io/oxidize-rb/xrubies__x86_64-linux__3.2-rc1:centos \
...
```dockerfile
FROM ghcr.io/oxidize-rb/xrubies__aarch64-linux__3.1:ubuntu as ruby-3.1
FROM ghcr.io/oxidize-rb/xrubies__aarch64-linux__3.0:ubuntu as ruby-3.0
FROM ghcr.io/oxidize-rb/xrubies__aarch64-linux__2.7:ubuntu as ruby-2.7
